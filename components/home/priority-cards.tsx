...
const CARDS: {
...
}[] = [
  {
    ...
    desc: 'Book your booth and put your technology in front of 40,000+ decision-makers.',
    badge: 'Booth booking open',
  ...
  },
  {
    ...
    desc: 'Apply for the Automation Deal Room and get matched in curated 1:1 meetings.',
    badge: 'Curated meetings',
  ...
  },
  {
    ...
    desc: 'Claim your complimentary pass with personalised zone & session picks.',
    badge: '100% Free',
