  ...
  sessions: [
      {
        ...
        speaker: "doexim Expert",
        speakerRole: "International Trade Expert",
        venue: "BEC, Hall 6",
        category: "Keynote",
      },
      {
        ...
        speaker: "doexim Expert",
        speakerRole: "Export Consultant",
        venue: "BEC, Hall 6",
        category: "Workshop",
      },
      {
        time: "12:30 PM",
        title: "Product & Market — What to Export & Where",
        speaker: "doexim Expert",
        speakerRole: "Global Market Specialist",
        venue: "BEC, Hall 6",
        category: "Panel",
      },
      {
        ...
        speaker: "doexim Expert",
        speakerRole: "International Buyer & Sourcing Expert",
        venue: "BEC, Hall 6",
        category: "Workshop",
      },
      {
        time: "3:00 PM",
        title: "Export Pricing — How to Quote Profitably",
        speaker: "doexim Expert",
        speakerRole: "Export Pricing Specialist",
        venue: "BEC, Hall 6",
        category: "Workshop",
      },
      {
        time: "4:00 PM",
        title: "INCOTERMS — Understanding International Trade Terms",
        speaker: "doexim Expert",
        speakerRole: "Trade & Logistics Expert",
        venue: "BEC, Hall 6",
        category: "Keynote",
      },
      {
        time: "5:00 PM",
        title: "First Export Order — Real Case Study",
        speaker: "Successful Exporter",
        speakerRole: "Exporter Success Story",
        venue: "BEC, Hall 6",
        category: "Panel",
      },
      {
        time: "5:30 PM",
        title: "Expert Q&A — Ask Anything About Export",
        speaker: "doexim Experts",
        speakerRole: "Open Expert Q&A",
        venue: "BEC, Hall 6",
        category: "Networking",
      },
    ],
  ...
  sessions: [
      {
        ...
        speaker: "doexim Experts",
        speakerRole: "EXIM Knowledge Recap",
        venue: "BEC, Hall 6",
        category: "Keynote",
      },
      {
        ...
        speaker: "doexim Expert",
        speakerRole: "Export Policy Specialist",
        venue: "BEC, Hall 6",
        category: "Keynote",
      },
      {
        ...
        speaker: "doexim Expert",
        speakerRole: "Export Compliance Expert",
        venue: "BEC, Hall 6",
        category: "Workshop",
      },
      {
        time: "1:00 PM",
        title: "Export Documentation — Complete Guide",
        speaker: "doexim Expert",
        speakerRole: "Export Documentation Specialist",
        venue: "BEC, Hall 6",
        category: "Workshop",
      },
      {
        ...
        speaker: "doexim Expert",
        speakerRole: "Trade Finance & Banking Expert",
        venue: "BEC, Hall 6",
        category: "Panel",
      },
      {
        time: "3:00 PM",
        title: "CHA / Customs Broker — What Every Exporter Must Know",
        speaker: "doexim Expert",
        speakerRole: "Customs & Compliance Expert",
        venue: "BEC, Hall 6",
        category: "Workshop",
      },
      {
        time: "3:45 PM",
        title: "Freight Forwarder — Booking Your Shipment",
        speaker: "doexim Expert",
        speakerRole: "Freight & Logistics Expert",
        venue: "BEC, Hall 6",
        category: "Workshop",
      },
      {
        time: "4:30 PM",
        title: "Factory to Foreign Port — Complete Shipment Journey",
        speaker: "doexim Experts",
        speakerRole: "End-to-End Logistics Experts",
        venue: "BEC, Hall 6",
        category: "Panel",
      },
      {
        time: "5:15 PM",
        title: "25 Costly Export Mistakes — And How to Avoid Them",
        speaker: "doexim Expert",
        speakerRole: "Export Risk Specialist",
        venue: "BEC, Hall 6",
        category: "Keynote",
      },
      {
        time: "5:45 PM",
        title: "ONE SHIPMENT — SIX EXPERTS",
        speaker: "Six Industry Experts",
        speakerRole: "Complete Export Journey Expert Panel",
        venue: "BEC, Hall 6",
        category: "Panel",
      },
    ],
  ...
  sessions: [
      {
        ...
        speaker: "doexim Expert",
        speakerRole: "Global Trade Strategist",
        venue: "BEC, Hall 6",
        category: "Keynote",
      },
      {
        ...
        speaker: "doexim Expert",
        speakerRole: "International Buyer Specialist",
        venue: "BEC, Hall 6",
        category: "Workshop",
      },
      {
        time: "12:00 PM",
        title: "Top Export Markets — Where Indian Businesses Can Grow",
        speaker: "doexim Expert",
        speakerRole: "Global Market Expert",
        venue: "BEC, Hall 6",
        category: "Panel",
      },
      {
        ...
        speaker: "doexim Expert",
        speakerRole: "Digital Export Marketing Specialist",
        venue: "BEC, Hall 6",
        category: "Workshop",
      },
      {
        time: "2:00 PM",
        title: "doexim.COM — Your Global Business Growth Engine",
        speaker: "doexim Team",
        speakerRole: "Digital Trade Platform",
        venue: "BEC, Hall 6",
        category: "Keynote",
      },
      {
        time: "3:00 PM",
        title: "Get Paid Safely — Payment Risk Management",
        speaker: "doexim Expert",
        speakerRole: "Trade Finance Expert",
        venue: "BEC, Hall 6",
        category: "Workshop",
      },
      {
        time: "3:45 PM",
        title: "ECGC — Protecting Your Export Receivables",
        speaker: "doexim Expert",
        speakerRole: "Export Credit & Risk Expert",
        venue: "BEC, Hall 6",
        category: "Panel",
      },
      {
        time: "4:30 PM",
        title: "E-Commerce — Selling Globally from India",
        speaker: "doexim Expert",
        speakerRole: "Cross-Border E-commerce Expert",
        venue: "BEC, Hall 6",
        category: "Workshop",
      },
      {
        time: "5:00 PM",
        title: "Export Success Stories — From India to the World",
        speaker: "Successful Exporters",
        speakerRole: "Real Export Success Stories",
        venue: "BEC, Hall 6",
        category: "Panel",
      },
      {
        time: "5:30 PM",
        title: "Global Scale-Up — Building a Worldwide Business",
        speaker: "doexim Expert",
        speakerRole: "Global Business Strategist",
        venue: "BEC, Hall 6",
        category: "Keynote",
      },
      {
        time: "6:00 PM",
        title: "90-Day Export Action Plan",
        speaker: "doexim Experts",
        speakerRole: "Your Roadmap to Going Global",
        venue: "BEC, Hall 6",
        category: "Workshop",
      },
    ],
