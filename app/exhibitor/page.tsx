...
export const metadata: Metadata = {
  title: "Exhibitors",
  description:
    "Meet the 500+ exhibitors showcasing B2B global trade solutions at doeximexpo 2027. Browse by category, search, and discover your next technology partner.",
}
        ...
        <div className="mx-auto w-full max-w-4xl text-center">
          ...
          <div className="mt-8">
            <CtaButton variant="gold" size="lg">
              Exhibit at B2B global trade Expo 2027
            </CtaButton>
          </div>
        </div>
      </section>
